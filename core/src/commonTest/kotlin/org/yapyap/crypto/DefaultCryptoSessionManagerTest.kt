...
import org.yapyap.crypto.e2ee.DoubleRatchetSession
import org.yapyap.crypto.e2ee.InnerSessionControl
import org.yapyap.crypto.e2ee.RatchetCiphertext
import org.yapyap.crypto.e2ee.RatchetInnerPlaintext
...
import org.yapyap.crypto.e2ee.maintainPeerSessions
import org.yapyap.persistence.db.OpkStatus
import org.yapyap.crypto.e2ee.OpkOfferBinding
import org.yapyap.crypto.e2ee.SessionUpgradePolicy
import org.yapyap.crypto.e2ee.SessionWireFrame
import org.yapyap.crypto.e2ee.X3dhHandshake
import org.yapyap.crypto.e2ee.X3dhLocalInitiatorKeys
import org.yapyap.crypto.e2ee.X3dhMode
import org.yapyap.crypto.e2ee.X3dhRemotePeerKeys
import org.yapyap.crypto.e2ee.X3dhWireInfo
...
class DefaultCryptoSessionManagerTest {
    ...
    fun epoch1_aliceFirstMessage_bobDecrypts() = runTest {
        val alicePeer = buildTestPeerIdentity(crypto, "alice")
        val bobPeer = buildTestPeerIdentity(crypto, "bob")
        val alice = managerForPeer(crypto, alicePeer, bobPeer, MapBackedCryptoSessionStore(), InMemoryOpkRepository(crypto))
        val bob = managerForPeer(crypto, bobPeer, alicePeer, MapBackedCryptoSessionStore(), InMemoryOpkRepository(crypto))
